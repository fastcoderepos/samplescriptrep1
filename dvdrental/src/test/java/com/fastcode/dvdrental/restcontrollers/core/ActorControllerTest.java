...
public class ActorControllerTest {
	...
	public ActorEntity createEntity() {
    	...
    	actorEntity.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-01"));
	...
	public CreateActorInput createActorInput() {
    	...
    	actorInput.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-10"));
	...
	public ActorEntity createNewEntity() {
		...
		actor.setLastName("3");
    	actor.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-11"));
	...
	public ActorEntity createUpdateEntity() {
		...
		actor.setLastName("4");
    	actor.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-09"));
	...
	public void UpdateActor_ActorDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		actor.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-28"));
