...
public class InventoryControllerTest {
	...
	public InventoryEntity createEntity() {
    	...
    	inventoryEntity.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-01"));
	...
	public CreateInventoryInput createInventoryInput() {
    	...
    	inventoryInput.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-10"));
	...
	public InventoryEntity createNewEntity() {
    	...
    	inventory.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-11"));
	...
	public InventoryEntity createUpdateEntity() {
    	...
    	inventory.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-09"));
	...
	public void UpdateInventory_InventoryDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		inventory.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-28"));
