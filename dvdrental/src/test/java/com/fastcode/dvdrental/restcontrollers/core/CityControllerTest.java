...
public class CityControllerTest {
	...
	public CityEntity createEntity() {
    	...
    	cityEntity.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-01"));
		cityEntity.setVersiono(0L);
		cityEntity.setCountry(country);
	...
	public CreateCityInput createCityInput() {
    	...
    	cityInput.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-10"));
	...
	public CityEntity createNewEntity() {
		...
		city.setCity("3");
		city.setCityId(3);
    	city.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-11"));
	...
	public CityEntity createUpdateEntity() {
		...
		city.setCity("4");
		city.setCityId(4);
    	city.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-09"));
	...
	public void UpdateCity_CityDoesNotExist_ReturnStatusNotFound() throws Exception {
        ...
        UpdateCityInput city = new UpdateCityInput();
  		city.setCity("999");
		city.setCityId(999);
		city.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-28"));
