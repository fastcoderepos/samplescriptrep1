...
public class FilmControllerTest {
	...
	public FilmEntity createEntity() {
    	...
    	filmEntity.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-01"));
	...
	public CreateFilmInput createFilmInput() {
    	...
    	filmInput.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-10"));
	...
	public FilmEntity createNewEntity() {
		...
		film.setFilmId(3);
    	film.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-11"));
	...
	public FilmEntity createUpdateEntity() {
		...
		film.setFilmId(4);
    	film.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-09"));
	...
	public void UpdateFilm_FilmDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		film.setFilmId(999);
		film.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-28"));
