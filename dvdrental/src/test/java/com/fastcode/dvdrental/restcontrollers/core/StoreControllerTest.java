...
public class StoreControllerTest {
	...
	public StoreEntity createEntity() {
    	...
    	storeEntity.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-01"));
	...
	public CreateStoreInput createStoreInput() {
    	...
    	storeInput.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-10"));
	...
	public StoreEntity createNewEntity() {
    	...
    	store.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-11"));
		store.setStoreId(3);
	...
	public StoreEntity createUpdateEntity() {
		StoreEntity store = new StoreEntity();
    	store.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-09"));
		store.setStoreId(4);
	...
	public void UpdateStore_StoreDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		store.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-28"));
