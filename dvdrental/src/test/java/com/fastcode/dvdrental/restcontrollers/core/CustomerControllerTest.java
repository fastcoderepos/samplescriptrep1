...
public class CustomerControllerTest {
	...
	public CustomerEntity createEntity() {
    	...
    	customerEntity.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-01"));
	...
	public CreateCustomerInput createCustomerInput() {
    	...
    	customerInput.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-10"));
	...
	public CustomerEntity createNewEntity() {
    	...
    	customer.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-11"));
	...
	public CustomerEntity createUpdateEntity() {
    	...
    	customer.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-09"));
	...
	public void UpdateCustomer_CustomerDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		customer.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-28"));
