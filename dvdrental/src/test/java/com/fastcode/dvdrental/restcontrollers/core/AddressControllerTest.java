...
public class AddressControllerTest {
	...
	public AddressEntity createEntity() {
    	...
    	addressEntity.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-01"));
	...
	public CreateAddressInput createAddressInput() {
    	...
    	addressInput.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-10"));
	...
	public AddressEntity createNewEntity() {
    	...
    	address.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-11"));
		address.setPhone("3");
	...
	public AddressEntity createUpdateEntity() {
    	...
    	address.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-09"));
		address.setPhone("4");
	...
	public void UpdateAddress_AddressDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		address.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-28"));
