...
public class RentalControllerTest {
	...
	public RentalEntity createEntity() {
		...
		RentalEntity rentalEntity = new RentalEntity();
    	rentalEntity.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-01"));
	...
	public CreateRentalInput createRentalInput() {
    	...
    	rentalInput.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-10"));
	...
	public RentalEntity createNewEntity() {
    	...
    	rental.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-11"));
	...
	public RentalEntity createUpdateEntity() {
		RentalEntity rental = new RentalEntity();
    	rental.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-09"));
	...
	public void UpdateRental_RentalDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		rental.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-28"));
