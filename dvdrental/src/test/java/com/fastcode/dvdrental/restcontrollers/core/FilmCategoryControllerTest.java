...
public class FilmCategoryControllerTest {
	...
	public CategoryEntity createCategoryEntity() {
		...
		categoryEntity.setLastUpdate(SearchUtils.stringToLocalDate("19"+countCategory+"-09-01"));
	...
	public RentalEntity createRentalEntity() {
		...
		rentalEntity.setLastUpdate(SearchUtils.stringToLocalDate("19"+countRental+"-09-01"));
	...
	public AddressEntity createAddressEntity() {
		...
		addressEntity.setLastUpdate(SearchUtils.stringToLocalDate("19"+countAddress+"-09-01"));
	...
	public LanguageEntity createLanguageEntity() {
		...
		languageEntity.setLastUpdate(SearchUtils.stringToLocalDate("19"+countLanguage+"-09-01"));
	...
	public FilmEntity createFilmEntity() {
		...
		filmEntity.setLastUpdate(SearchUtils.stringToLocalDate("19"+countFilm+"-09-01"));
	...
	public CustomerEntity createCustomerEntity() {
		...
		customerEntity.setLastUpdate(SearchUtils.stringToLocalDate("19"+countCustomer+"-09-01"));
	...
	public StaffEntity createStaffEntity() {
		...
		staffEntity.setLastUpdate(SearchUtils.stringToLocalDate("19"+countStaff+"-09-01"));
	...
	public CityEntity createCityEntity() {
		...
		cityEntity.setLastUpdate(SearchUtils.stringToLocalDate("19"+countCity+"-09-01"));
	...
	public InventoryEntity createInventoryEntity() {
		...
		inventoryEntity.setLastUpdate(SearchUtils.stringToLocalDate("19"+countInventory+"-09-01"));
	...
	public FilmCategoryEntity createEntity() {
    	...
    	filmCategoryEntity.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-01"));
	...
	public CreateFilmCategoryInput createFilmCategoryInput() {
    	...
    	filmCategoryInput.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-10"));
	...
	public FilmCategoryEntity createNewEntity() {
    	...
    	filmCategory.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-11"));
	...
	public FilmCategoryEntity createUpdateEntity() {
    	...
    	filmCategory.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-09"));
	...
	public void UpdateFilmCategory_FilmCategoryDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		filmCategory.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-28"));
