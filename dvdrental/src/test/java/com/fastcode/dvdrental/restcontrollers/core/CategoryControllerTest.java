...
public class CategoryControllerTest {
	...
	public CategoryEntity createEntity() {
    	...
    	categoryEntity.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-01"));
	...
	public CreateCategoryInput createCategoryInput() {
    	...
    	categoryInput.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-10"));
	...
	public CategoryEntity createNewEntity() {
    	...
    	category.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-11"));
		category.setName("3");
	...
	public CategoryEntity createUpdateEntity() {
    	...
    	category.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-09"));
		category.setName("4");
	...
	public void UpdateCategory_CategoryDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		category.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-28"));
