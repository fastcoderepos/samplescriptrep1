...
public class StaffControllerTest {
	...
	public StaffEntity createEntity() {
    	...
    	staffEntity.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-01"));
	...
	public CreateStaffInput createStaffInput() {
    	...
    	staffInput.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-10"));
	...
	public StaffEntity createNewEntity() {
		...
		staff.setLastName("3");
    	staff.setLastUpdate(SearchUtils.stringToLocalDate("1996-08-11"));
		staff.setPassword("3");
		staff.setStaffId(3);
	...
	public StaffEntity createUpdateEntity() {
		...
		staff.setLastName("4");
    	staff.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-09"));
		staff.setPassword("4");
		staff.setStaffId(4);
	...
	public void UpdateStaff_StaffDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		staff.setLastUpdate(SearchUtils.stringToLocalDate("1996-09-28"));
