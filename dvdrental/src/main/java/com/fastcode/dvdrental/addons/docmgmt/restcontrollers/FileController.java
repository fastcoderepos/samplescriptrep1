package com.fastcode.dvdrental.addons.docmgmt.restcontrollers;

import com.fastcode.dvdrental.addons.docmgmt.application.file.IFileAppService;
import com.fastcode.dvdrental.addons.docmgmt.application.file.IFileMapper;
...
import com.fastcode.dvdrental.addons.docmgmt.domain.file.IFileContentStore;
...
public class FileController {
    ...
    public void delete(@PathVariable String id) {
        ...
        Optional.ofNullable(output).orElseThrow(() -> new EntityNotFoundException(String.format("There does not exist a file with a id=%s", id)));
    ...
    @RequestMapping(value = "/file/{id}", method = RequestMethod.PUT, consumes = {"application/json"}, produces = {"application/json"})
    public ResponseEntity<UpdateFileOutput> update(@PathVariable String id, @RequestBody @Valid UpdateFileInput file) {
        ...
        Optional.ofNullable(currentFile).orElseThrow(() -> new EntityNotFoundException(String.format("Unable to update. File with id=%s not found.", id)));
        UpdateFileOutput output = _fileAppService.update(Long.valueOf(id),file);
        return new ResponseEntity(output, HttpStatus.OK);
    }

	@PreAuthorize("hasAnyAuthority('FILEENTITY_READ')")
    @RequestMapping(value = "/file/{id}", method = RequestMethod.GET, consumes = {"application/json"}, produces = {"application/json"})
    public ResponseEntity<FindFileByIdOutput> findById(@PathVariable String id) {

        FindFileByIdOutput output = _fileAppService.findById(Long.valueOf(id));
        Optional.ofNullable(output).orElseThrow(() -> new EntityNotFoundException(String.format("The entity with the provided Id has not been found.")));

        return new ResponseEntity(output, HttpStatus.OK);
    }

	@PreAuthorize("hasAnyAuthority('FILEENTITY_READ')")
    @RequestMapping(value = "/file", method = RequestMethod.GET, consumes = {"application/json"}, produces = {"application/json"})
	...
	@PreAuthorize("hasAnyAuthority('FILEENTITY_READ')")
    @RequestMapping(value = "/file/content/{fileId}", method = RequestMethod.GET, consumes = {"application/json"}, produces = {"application/hal+json"})
    ...
    @RequestMapping(value = "/file/{fileId}/lock", method = RequestMethod.PUT, consumes = {"application/json"}, produces = {"application/hal+json"})
    ...
    @RequestMapping(value = "/file/{fileId}/unlock", method = RequestMethod.DELETE, consumes = {"application/json"}, produces = {"application/hal+json"})
    ...
    @RequestMapping(value = "/file/{fileId}/version", method = RequestMethod.PUT, consumes = {"application/json"}, produces = {"application/hal+json"})
    ...
    @RequestMapping(value = "/file/{id}/findAllVersions", method = RequestMethod.GET, consumes = {"application/json"}, produces = {"application/hal+json"})
	...
	@PreAuthorize("hasAnyAuthority('VERSION_READ')")
    @RequestMapping(value = "/file/findAllVersionsLatest", method = RequestMethod.GET, consumes = {"application/json"}, produces = {"application/hal+json"})
