...
public class ReportController {
	...
	public ReportController(IReportAppService reportAppService, IDashboardversionreportAppService reportdashboardAppService, IUserAppServiceExtended userAppService,
	...
	public ResponseEntity<FindReportByIdOutput> findById(@PathVariable String id) {
		...
		FindReportByIdOutput output = _reportAppService.findByReportIdAndUserId(Long.valueOf(id), user.getId(), "running");
	...
	public ResponseEntity<FindReportByIdOutput> getPublishedVersion(@PathVariable String id) {
		...
		FindReportByIdOutput output = _reportAppService.findByReportIdAndUserId(Long.valueOf(id), user.getId(), "published");
		Optional.ofNullable(output).orElseThrow(() -> new EntityNotFoundException(String.format("Not found")));
