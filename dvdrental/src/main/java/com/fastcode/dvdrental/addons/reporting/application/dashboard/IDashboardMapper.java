...
public interface IDashboardMapper {
	...
	FindDashboardByIdOutput dashboardEntitiesToFindDashboardByIdOutput(DashboardEntity dashboard, DashboardversionEntity dashboardversion);

	@Mappings({
		@Mapping(source = "dashboardversion.userId", target = "userId"), 
		@Mapping(source = "dashboardversion.dashboardId", target = "id"),
	})
	DashboardDetailsOutput dashboardEntitiesToDashboardDetailsOutput(DashboardEntity dashboard, DashboardversionEntity dashboardversion);
