package com.fastcode.dvdrental.addons.scheduler.application.job;
...
import com.fastcode.dvdrental.DvdrentalApplication;
import com.fastcode.dvdrental.addons.scheduler.constants.QuartzConstants;
import com.fastcode.dvdrental.addons.scheduler.domain.job.JobEntity;
import com.fastcode.dvdrental.addons.scheduler.domain.job.IJobRepository;
...
import com.fastcode.dvdrental.addons.scheduler.domain.job.QJobEntity;
import com.fastcode.dvdrental.addons.scheduler.domain.jobhistory.QJobHistoryEntity;
import com.fastcode.dvdrental.addons.scheduler.CGenClassLoader;
...
public class JobAppService implements IJobAppService {
	...
	public List<String> listAllJobClasses() throws URISyntaxException {
		...
		URI uri = DvdrentalApplication.class.getResource("/").toURI();
