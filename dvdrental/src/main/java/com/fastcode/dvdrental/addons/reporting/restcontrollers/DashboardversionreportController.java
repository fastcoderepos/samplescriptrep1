...
public class DashboardversionreportController {
	...
	@PreAuthorize("hasAnyAuthority('REPORTDASHBOARDENTITY_READ')")
	@RequestMapping(value = "/{id}/dashboard", method = RequestMethod.GET, consumes = {"application/json"}, produces = {"application/json"})
	...
	@PreAuthorize("hasAnyAuthority('REPORTDASHBOARDENTITY_READ')")
	@RequestMapping(value = "/{id}/report", method = RequestMethod.GET, consumes = {"application/json"}, produces = {"application/json"})
