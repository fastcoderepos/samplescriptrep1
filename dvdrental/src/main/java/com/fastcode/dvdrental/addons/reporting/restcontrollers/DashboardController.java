package com.fastcode.dvdrental.addons.reporting.restcontrollers;
...
import com.fastcode.dvdrental.addons.reporting.application.dashboard.IDashboardAppService;
...
import com.fastcode.dvdrental.addons.reporting.application.dashboardversionreport.dto.FindDashboardversionreportByIdOutput;
...
public class DashboardController {
	...
	public DashboardController(IDashboardAppService dashboardAppService, IDashboardversionreportAppService reportdashboardAppService, IUserAppServiceExtended userAppService,
	...
	public ResponseEntity<FindDashboardByIdOutput> findById(@PathVariable String id) {
		...
		UserEntity user = _userAppService.getUser();
		FindDashboardByIdOutput output = _dashboardAppService.findByDashboardIdAndUserId(Long.valueOf(id), user.getId(), "running");
	...
	public ResponseEntity<FindDashboardByIdOutput> getPublishedVersion(@PathVariable String id) {
		...
		UserEntity user = _userAppService.getUser();
		FindDashboardByIdOutput output = _dashboardAppService.findByDashboardIdAndUserId(Long.valueOf(id), user.getId(), "published");
