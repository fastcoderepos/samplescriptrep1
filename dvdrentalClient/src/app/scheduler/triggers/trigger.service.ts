...
export class TriggerService {
  ...
  public getTriggerExecutionHistoryByJob(triggerName:string, triggerGroup:string, searchFields: ISearchField[], offset:number ,limit:number , sort:string): Observable<IExecutionHistory[]> {
    let params = ServiceUtils.buildQueryData(searchFields,offset,limit,sort);
    return this.httpclient.get<IExecutionHistory[]>(`${this.baseUrl}/${triggerName}/${triggerGroup}/jobExecutionHistory`,{params}).pipe(catchError(this.handleError))
  }
