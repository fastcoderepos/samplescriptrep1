...
export class JobService {
  ...
  public getJobExecutionHistoryByJob(jobName:string, jobGroup:string, searchFields: ISearchField[], offset:number ,limit:number , sort:string): Observable<IExecutionHistory[]> {
    let params = ServiceUtils.buildQueryData(searchFields,offset,limit,sort);
    return this.httpclient.get<IExecutionHistory[]>(`${this.baseUrl}/${jobName}/${jobGroup}/jobExecutionHistory`,{params}).pipe(catchError(this.handleError))
  }
