...
import { ILanguage, LanguageService, LanguageDetailsComponent, LanguageListComponent } from '../';
...
describe('LanguageDetailsComponent', () => {
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'language/:id', component: LanguageListComponent }
          ])
        ],
        providers: [
          LanguageService
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/language');
